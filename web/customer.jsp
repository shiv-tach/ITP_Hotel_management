        ...
        <div class="d-flex align-items-stretch">
            <div id="sidebar" class="sidebar py-3">
                ...
                <ul class="sidebar-menu list-unstyled">
                    <li class="sidebar-list-item"><a href="customer.jsp" class="sidebar-link text-muted active"><i class="o-user-details-1 mr-3 text-gray"></i><span>Customer</span></a></li>
                    ...
                    <li class="sidebar-list-item"><a href="tours.jsp" class="sidebar-link text-muted"><i class="o-earth-globe-1 mr-3 text-gray"></i><span>Tours</span></a></li>
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal" id="form">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input id="contact_no" type="text" onkeypress="onClickValidationContactNumber()" maxlength="10"	placeholder="contact no" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
